//! `hypno-cli` — Interactive LLM chat engine using `.hypno` models.
//!
//! Usage:
//! ```bash
//! hypno-cli --model path/to/model.hypno --prompt "Hello, world!"
//! hypno-cli --model model.hypno                     # interactive mode
//! ```
